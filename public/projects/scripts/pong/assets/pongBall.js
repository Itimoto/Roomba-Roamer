...
class Ball extends GameObject {
    constructor(opts){
        ...
        if(this.bounds){
            this.x = (this.bounds.width / 2) + this.offsetX;
            this.y = (this.bounds.height / 2) + this.offsetY;
    ...
    genXVel(speedRange){
        ...
        this.xVel =  this.maxVel * (2 - (4*Math.round(Math.random()))) || this.maxVel * 0.8; // Must never be 0
        return this.xVel;
    }
/*
    _reset(){   // `extends` pongGameObject.reset()
        this.genXVel();
    }
    */
}
